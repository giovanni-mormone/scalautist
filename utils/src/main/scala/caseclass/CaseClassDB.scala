...
object CaseClassDB{
  ...
  final case class Persona(nome:String,cognome:String,numTelefono:String,password:String,ruolo:Int,idTerminale:Option[Int]=None,matricola:Option[Int]=None)

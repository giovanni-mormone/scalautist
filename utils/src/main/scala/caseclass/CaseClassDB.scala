...
object CaseClassDB{
   ...
   * @param partTime wheter or not the contratto is part time
   ...
   */
  final case class Contratto(tipoContratto:String,turnoFisso:Boolean,partTime:Boolean,ruolo:Int,idContratto:Option[Int]=None)
   ...
   */
  final case class RichiestaTeorica(dataInizio:Date,dataFine:Date,terminaleId:Int,idRichiestaTeorica:Option[Int]=None)

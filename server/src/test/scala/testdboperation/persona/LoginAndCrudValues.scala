...
object LoginAndCrudValues {
    val persona: Persona = Persona("Fabian", "Aspee", "569918598", Some(""), 1, isNew = true, "admin", None, None, Some(1))
    val persona2: Persona = Persona("Fabian", "Aspee", "569918598", Some(""), 1, isNew = false, "admin", None, None, Some(1))

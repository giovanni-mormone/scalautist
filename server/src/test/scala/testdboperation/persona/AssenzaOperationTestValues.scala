...
object AssenzaOperationTestValues {
  val remainingFerieList= List(Ferie(2,"FrancescoCassano2",11), Ferie(4,"LucianoFuentes4",19), Ferie(5,"ValerioVigliano5",7)
    , Ferie(6,"ConducenteMaestro6",0), Ferie(7,"ProVa7",19), Ferie(8,"MAttoMattesi8",35))
  ...
  val goodFerie: Assenza = Assenza(5, new Date(120,11,1), new Date(120,11,7),malattia = false)

...
object t extends App{
  ...
  val secondDateGroup2: Date =Date.valueOf(LocalDate.of(2020,7,15))
  val firstDateGroup2: Date =Date.valueOf(LocalDate.of(2020,7,10))
  val secondDateGroup3: Date =Date.valueOf(LocalDate.of(2020,7,15))
  val firstDateGroup3: Date =Date.valueOf(LocalDate.of(2020,7,10))
  val secondDateGroup4: Date =Date.valueOf(LocalDate.of(2020,7,15))
  val gruppi = List(GruppoA(1,List(firstDateGroup,secondDateGroup,thirdDateGroup),2))

...
object Helper {
  ...
  val personaSelect:PersonaTableRep => (Rep[String], Rep[String], Rep[String], Option[String], Rep[Int],Rep[Boolean],Rep[String], Rep[Option[Int]], Rep[Option[Int]]) =  f => ( f.nome, f.cognome, f.numTelefono, Option[String](EMPTY_STRING), f.ruolo,f.isNew,f.userName, f.terminaleId, f.id.?)
